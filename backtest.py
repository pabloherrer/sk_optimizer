...
from forecast.consumption import estimate_consumption_rates as legacy_rates

from state.manager import InventoryState, ClientState
...
from solver.objective import calibrate_legacy_knobs, cost_units_per_dollar
from state.warm_start import shift_plan_for_today, _vehicle_index
