...
SUITES = [
    ...
    ('cost_model',
     'tests.test_cost_model', 'run_all_tests',
     'Cost model accuracy (labor + OT)', 'fast'),
    ('edge_cases',
     'tests.test_edge_cases', 'run_all_tests',
     'Edge cases (tiny/huge/degenerate)', 'fast'),
    ('invariants_plus',
     'tests.test_invariants_plus', 'run_all_tests',
     'Invariants-plus + monotonicity + continuity', 'fast'),
    ('determinism_golden',
     'tests.test_determinism_golden', 'run_all_tests',
     'Determinism + golden baseline regression', 'fast'),
    ('equity',
     'tests.test_equity', 'run_all_tests',
     'Equity / fairness across weeks', 'fast'),
    ('robustness_plus',
     'tests.test_robustness_plus', 'run_all_tests',
     'Robustness-plus (operational shocks)', 'fast'),
    ('tw_interactions',
     'tests.test_tw_interactions', 'run_all_tests',
     'TW × closure/capacity/overlap interactions', 'fast'),
    ('optimality',
     'tests.test_optimality', 'run_all_tests',
     'Solver optimality / quality bounds', 'fast'),
    ('efficiency_metrics',
     'tests.test_efficiency_metrics', 'run_all_tests',
     'Business KPI bounds (cost/gal, mi/stop, load factor)', 'fast'),
    ('plan_stability',
     'tests.test_plan_stability', 'run_all_tests',
     'Plan stability across rolling re-solves', 'fast'),
